            ...
            <div class="bg-[#231910] rounded-xl p-8">
              ...
              <form @submit.prevent="submitForm" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label class="block text-sm font-medium text-[#ccaa8e] mb-2" for="name">Name</label>
                    <input
                  ...
                  <div>
                    <label class="block text-sm font-medium text-[#ccaa8e] mb-2" for="email">Email Address</label>
                    <input
...
// State
const { profileForm, isLoading, sameAsShipping } = useProfileState()
