...
const {
  ...
  toggleOrderStatus,
  exportSingleOrder
} = useOrdersAPI(isLoading, error, orders)
...
const {
  ...
  duplicateOrder,
  handleClickOutside
} = useOrdersActions(showMoreActions, showConfirmModal, confirmModal, showToast, toastMessage, toastType, statusFilter, searchQuery, performDelete, performDuplicate)
...
onMounted(() => {
  initOrders(loadOrders, handleClickOutside)
})
