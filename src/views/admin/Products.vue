            ...
            <div class="flex justify-between items-center mb-6">
              ...
              <div class="flex gap-2">
                ...
                <button
                  ...
                  @click="exportProducts(showToastMessage)"
...
const updateCategoryCounts = () => {
  ...
  if (products.value && products.value.length > 0) {
    ...
    console.log('Updating category counts for', products.value.length, 'products')
    ...
    console.log('No products to count')
...
const exportSingleProduct = (product) => {
  ...
  try {
    ...
    console.log('Exporting single product:', product)
...
const handleUpdateProduct = async () => {
  ...
  try {
    ...
    console.log('Updating product:', editProductForm.value)
...
onMounted(async () => {
  ...
  console.log('Products loaded, updating category counts...')
